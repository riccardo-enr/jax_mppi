...
The project uses `pytest` for running tests. The test suite is designed to ensure the correctness of core algorithms, check for regressions, and validate integration with different environments.

## Running Tests

You can run all tests using `uv`:
