...
This requires `ray[tune]`, `hyperopt`, and `bayesian-optimization`. Install with `pip install jax-mppi[autotuning-extra]`.
:::
...
### Global Optimization with Ray Tune (Theory)
