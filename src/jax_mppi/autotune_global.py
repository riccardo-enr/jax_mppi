...
This module provides Ray Tune integration for distributed global search.
...
class GlobalTunableParameter(TunableParameter):
    ...
    Extends TunableParameter with search space info for global optimization.
    """
...
class RayOptimizer(Optimizer):
    ...
    Uses Ray Tune algorithms (HyperOpt, BayesOpt, etc.)
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install: pip install 'ray[tune]' hyperopt bayes-opt"
            )
