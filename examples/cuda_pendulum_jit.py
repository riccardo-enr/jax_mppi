...
def main():
    ...
    if cuda_mppi_include:
        ...
        potential_include = os.path.join(script_dir, "../src/cuda_mppi/include")
    ...
    try:
        ...
        print("\nTroubleshooting:")
        print(
            "  1. Set CUDA_MPPI_INCLUDE_DIR to point to src/cuda_mppi/include"
        )
        print("  2. Ensure CUDA toolkit is installed")
        print(
            f"     export CUDA_MPPI_INCLUDE_DIR={os.path.abspath('../src/cuda_mppi/include')}"
        )
        return
