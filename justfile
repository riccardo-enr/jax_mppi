...
figure8:
    uv run python examples/quadrotor/figure8_comparison.py --visualize
...
figure8-custom steps samples horizon lambda:
    uv run python examples/quadrotor/figure8_comparison.py \
        --steps {{ steps }} \
        --samples {{ samples }} \
        --horizon {{ horizon }} \
        --lambda {{ lambda }} \
...
help-figure8:
    uv run python examples/quadrotor/figure8_comparison.py --help
